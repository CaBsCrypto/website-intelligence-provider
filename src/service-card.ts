export const serviceCard = {
  ...
  capabilities: ["identity", "security", "seo", "accessibility", "performance"],
  interfaces: { http: { method: "POST", path: "/v1/audits" }, mcp: { tool: "audit_website" } },
  networkPolicy: { default: "deny", fixtureOnly: true, outboundRequests: false },
